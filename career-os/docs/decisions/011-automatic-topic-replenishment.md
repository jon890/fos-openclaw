...
범위는 두 축이다.
- study-pack topic reservoir
- live-coding primary seed reservoir
...
5. primary curated 미생성 재고가 목표치보다 적으면 study candidate 중 일부를 자동 promotion한다.
6. live-coding primary 잔여 seed가 목표치보다 적으면 live-coding candidate seed 중 일부를 자동 promotion한다.
7. `refresh_topic_inventory.py`를 다시 실행해 runtime inventory를 갱신한다.
...
- 아침 추천 전 study/live-coding 재고가 자동으로 채워진다.
